...
#pragma region Stable-ish version
    ...
    struct IHierarchyTree
    {
        ...
        virtual InheritNode GetInheritNode(const IHierarchyTree* other) const = 0;
    ...
    struct InheritanceTree : public HierarchyTree
    {
        ...
        {
            //TODO: Do better on this, post affixes need to be handle.
            return {};
        ...
        void SetInheritFrom(IHierarchyTree* other, Access a_access, bool post_affixed = false)
        {
            ...
            for (auto& data : inherits) {
                ...
                if (data.IsInternal() == false) {
                    if (prev_data) {
                        ...
                        prev_data->SetNilHash(both_affixed);
