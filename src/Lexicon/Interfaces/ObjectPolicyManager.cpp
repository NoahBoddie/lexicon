...
namespace LEX
{
	...
	ObjectPolicy* ObjectPolicyManager::RegisterObjectType(ObjectVTable* vtable, api::vector<std::string_view> aliases, std::string_view category, TypeOffset range, DataBuilder builder, HMODULE source)
	{
