...
namespace LEX
{
	...
	namespace Version
	{
		namespace _1
		{
			...
			{
				[[nodiscard]] virtual uint64_t RequestFormula(const LEX::ISignature& base, api::vector<std::string_view> params, 
	...
	{
		[[nodiscard]] uint64_t RequestFormula(const ISignature& base, api::vector<std::string_view> params, 
